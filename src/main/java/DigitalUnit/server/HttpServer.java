...
public class HttpServer{
	...
	public HttpServer()
	{
		try {
			...
			single_line_connection = new HttpConnection("http://easycrash.xyz/api/add_data");
			many_lines_connection = new HttpConnection("http://easycrash.xyz/api/add_bulk_data");
